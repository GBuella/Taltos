...
static const unsigned piece_mask = (pawn|king|rook|knight|bishop|queen);
...
static const int rsouth = +1;
static const int rnorth = -1;
...
static const int feast = -1;
static const int fwest = +1;
