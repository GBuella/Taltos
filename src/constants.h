...
bbetween(int i0, int i1)
{
	return bishop_masks[i0] & bishop_masks[i1];
}

static inline uint64_t
rbetween(int i0, int i1)
{
	return rook_masks[i0] & rook_masks[i1];
}

static inline uint64_t
between(int i0, int i1)
{
	return bbetween(i0, i1) | rbetween(i0, i1);
}
*/
